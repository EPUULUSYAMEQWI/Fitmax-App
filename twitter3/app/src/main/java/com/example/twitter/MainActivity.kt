...
import com.example.twitter.databinding.TwitterItemListBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun displayTweets(){
        var tweet = Tweets("Lucy @nyakuar122 Jul 9,2022","Software Developer","","","34","","10","50","218","","20")
        ...
        var twiiterAdapter  = twiiterRvAS (tweetsList )
        binding.rvtwitter .layoutManager = LinearLayoutManager(this)
        binding.rvtwitter .adapter = twiiterAdapter
    }
}